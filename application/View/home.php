    ...
    <!-- //SMARTPHONE CONTENT 1 -->
        <div class="col-sm-3">
          ...
          <a href="#"   id="articleSmartphone<?php echo $x;?>">
            <img src="libs/images/<?php echo $gambar;?>" style="width:100%;height:100%;">
...
?>
    ...
    background-repeat-x: initial;">
          <h4 style="font-family: fantasy;
    font-size: 40px;
    font-style: italic;"><a href="#" style="color:black;" id="softwareArticle">SOFTWARE</a></h4>
          </div>
        </div>
<?php
       $iter = $ad->read("count4");
...
?>
        <div class="col-sm-3">
          <div class="well">
            ...
            <img src="libs/images/<?php echo $gambar;?>" style="width:100%;height:100%;">
            <p style="font-size:25px; font-style:bold;"><?php echo $judul?></p></a>
            <p style="font-size:15px;">Oleh:<?php echo $username; ?></p>          </div>
        </div>
<?php $v++; } ?>
<script type="text/javascript">
  ...
  $(document).ready(function(){
     ...
     $("#smartphoneArticle").click(function(){
         $("#main").load("application/View/ListArticle.php?categori=1");
     });
     $("#softwareArticle").click(function(){
         $("#main").load("application/View/ListArticle.php?categori=4");
     });
     $("#hardwareArticle").click(function(){
         $("#main").load("application/View/ListArticle.php?categori=3");
     });
     ...
     for(let i=0;i<sizeArray;i++){
         $("#articleSmartphone"+i).click(function(){
          $("#main").load("application/View/ReadArticle.php?ID="+arr[i]);
       });  
     }
     ...
     for(let i=0;i<sizeArraySoftware;i++){
         $("#articleSoftware"+i).click(function(){
          $("#main").load("application/View/ReadArticle.php?ID="+arrSoftware[i]);
       });  
     }
     ...
     for(let i=0;i<sizeArrayHardware;i++){
         $("#articleHardware"+i).click(function(){
          $("#main").load("application/View/ReadArticle.php?ID="+arrHardware[i]);
       });  
     }
